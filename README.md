...
S0: старт -> s1
S1: первый символ часа ('0' или '1') ->
S2: второй символ часа ('0'-'9' или '2' для '12')
S3: двоеточие ':'
S4: первая цифра минут ('0'-'5')
S5: вторая цифра минут ('0'-'9')
S6: пробел (опционально)
S7: A или P
S8: M
